...
def showHeader():
	...
	menuItemHelp = htmlify.getHTML("li", contents=htmlify.getHTML("a", contents="Help", href="/cgi-bin/ic/help.py"))  # menu item 2 -- Help
	menuItemLogin = htmlify.getHTML("li", contents=htmlify.getHTML("a", contents="Login", href="/cgi-bin/ic/login.py"))  # menu item 3 -- Login
